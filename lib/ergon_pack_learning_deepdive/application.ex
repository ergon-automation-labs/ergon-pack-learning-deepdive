defmodule ErgonPackLearningDeepdive.Application do
  @moduledoc """
  Learning Deepdive pack supervisor.
  ...
  def start(_type, _args) do
    ...
    opts = [strategy: :one_for_one, name: ErgonPackLearningDeepdive.Supervisor]
